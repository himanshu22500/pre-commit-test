...
@pytest.fixture
def racecar():
    racecar_obj = RaceCar(color=RACECAR_COLOR,
...
def test_racecar_constructor_valid_inputs(color,max_speed, acceleration, tyre_friction, nitro):
    racecar_obj = RaceCar(color=color, 
                      max_speed=max_speed, 
